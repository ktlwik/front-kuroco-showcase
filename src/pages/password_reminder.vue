<template>
  <v-layout>
    <v-flex>
      ...
      <h3 v-if="e1==2" align="center" style="font-weight: normal;"> Input your password </h3>
      <br/> 
      <v-card v-if="e1==1">
          <v-form
            ref="form1"
          ...
          >
            <v-container fluid>
              <v-row>
                <v-col cols="12">
                  <p>
                    A password reset URL will be sent to the email address you provided.
                  </p>
                  <p>
                    <v-text-field
                      v-model="email"
          ...
          >
            <v-container fluid>
              <v-row>
                <v-col cols="12">
                  <p align="center">
                    A password reset URL has been sent to <br/> the email address you provided.
                  </p>
                </v-col>
              </v-row>
            </v-container>
